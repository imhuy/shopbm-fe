...
const CheckoutPage = () => {
  const [tabActive, setTabActive] = useState<"ContactInfo" | "ShippingAddress" | "PaymentMethod">("PaymentMethod");
      ...
      <main className="container py-16 lg:pb-28 lg:pt-20 ">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[36%] ">
            ...
            <ButtonPrimary className="mt-8 w-full">Xác Nhận</ButtonPrimary>
