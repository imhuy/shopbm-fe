      ...
      <div className="space-y-8">
        ...
        <div>
          <h2 className="text-2xl font-semibold hover:text-primary-6000 transition-colors">
            <Link href="/product-detail">BM50 CỔ 2017-2022</Link>
          </h2>
        ...
        <div className="flex space-x-3.5 rtl:space-x-reverse">
          ...
          >
            ...
            <span className="ms-3">Mua Ngay</span>
          </ButtonPrimary>
        </div>
          ...
          data={[
            {
              name: "Mô tả sản phẩm",
              content:
                `<span>  Giới hạn chi tiêu trên ngày: 230.000 VNĐ ( 10 USD )  </span> <br

                <span>  Số tài khoản quảng cáo tạo sẵn: 0  </span> <br
                
                <span> Thời gian tạo: RANDOM NĂM 2018 -> 2022  </span> <br
                
                <span>  Trạng thái xác minh mail: YES  </span> <br
                
                <span>  Trạng thái xác minh doanh nghiệp: NO  </span> <br
                
                <span> Nguồn gốc: Được scan từ via ngoại cổ  </span> <br
                
                <span> Ưu điểm: Chạy tốt hàng sạch, hàng vi phạm nhẹ, hàng vi phạm nặng </span> <br
                `,
            }
          ]}
        />
